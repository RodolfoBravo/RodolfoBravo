...
<div align="center">
  <h1>Hi 👋, I'm Rodolfo Bravo</h1>
  <h3>Senior Full Stack Developer & Electronics Engineer</h3>
...
<h2>🚀 About Me</h2>
<p>
  I am an <strong>Electronics Engineer and Senior Full Stack Developer</strong> with <strong>7+ years of professional experience</strong> specialized in web and mobile application ecosystem. I am highly passionate about engineering smart tools and architectures that empower companies to automate daily, complex, and repetitive workflows.
</p>
<p>
  Driven by continuous growth, I actively integrate <strong>AI-assisted engineering</strong> into my development pipeline, ensuring rapid prototyping, clean code structures, and cutting-edge digital solutions for this technical era.
</p>

<hr style="border: 1px solid #222; margin: 30px 0;" />

<!-- Sección de Tecnologías con Grid Limpio e Iconos Homogéneos -->
...
<div style="background-color: #0d1117; padding: 15px; border-radius: 10px; border: 1px solid #30363d; margin-bottom: 20px;">
  <h3 style="margin-top: 0; color: #58a6ff;">🎯 Frontend & Mobile</h3>
  <div style="display: flex; flex-wrap: wrap; gap: 12px; align-items: center;">
    <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/react/react-original.svg" alt="React" width="40" height="40" title="React / React Native" />
    <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/angular/angular-original.svg" alt="Angular" width="40" height="40" title="Angular" />
...
<!-- BACKEND & SYSTEMS -->
<div style="background-color: #0d1117; padding: 15px; border-radius: 10px; border: 1px solid #30363d; margin-bottom: 20px;">
  <h3 style="margin-top: 0; color: #3fb950;">⚙️ Backend & Core Systems</h3>
  <div style="display: flex; flex-wrap: wrap; gap: 12px; align-items: center;">
...
<!-- CLOUD & DEVOPS -->
<div style="background-color: #0d1117; padding: 15px; border-radius: 10px; border: 1px solid #30363d; margin-bottom: 20px;">
  <h3 style="margin-top: 0; color: #f778ba;">☁️ Cloud, Databases & DevOps</h3>
  <div style="display: flex; flex-wrap: wrap; gap: 12px; align-items: center;">
...
<!-- TOOLS & HARDWARE -->
<div style="background-color: #0d1117; padding: 15px; border-radius: 10px; border: 1px solid #30363d; margin-bottom: 20px;">
  <h3 style="margin-top: 0; color: #ff7b72;">🧠 AI, Hardware & Workflow Tools</h3>
  <div style="display: flex; flex-wrap: wrap; gap: 12px; align-items: center;">
    <img src="https://www.vectorlogo.zone/logos/github/github-icon.svg" alt="AI Assisted / GitHub" width="40" height="40" title="GitHub / AI Assisted Development" />
    <img src="https://www.vectorlogo.zone/logos/git-scm/git-scm-icon.svg" alt="Git" width="40" height="40" title="Git" />
    <img src="https://cdn.worldvectorlogo.com/logos/arduino-1.svg" alt="Arduino" width="40" height="40" title="Arduino Hardware Integration" />
    <img src="https://www.vectorlogo.zone/logos/opencv/opencv-icon.svg" alt="OpenCV" width="40" height="40" title="OpenCV" />
    <img src="https://www.vectorlogo.zone/logos/figma/figma-icon.svg" alt="Figma" width="40" height="40" title="Figma UI/UX" />
    <img src="https://www.vectorlogo.zone/logos/getpostman/getpostman-icon.svg" alt="Postman" width="40" height="40" title="Postman API Testing" />
    <img src="https://raw.githubusercontent.com/devicons/devicon/2ae2a900d2f041da66e950e4d48052658d850630/icons/pandas/pandas-original.svg" alt="Pandas" width="40" height="40" title="Pandas Data Science" />
